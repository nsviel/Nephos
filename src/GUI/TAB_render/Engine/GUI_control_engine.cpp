...
GUI_control_engine::GUI_control_engine(GUI* gui){
  //---------------------------
...
GUI_control_engine::~GUI_control_engine(){}

//Main function
void GUI_control_engine::run_control(ImVec2 center){
  //---------------------------
...
//Keyboard
void GUI_control_engine::control_keyboard_oneAction(){
...
void GUI_control_engine::control_keyboard_camMove(){
  ImGuiIO io = ImGui::GetIO();
  //----------------------------
...
void GUI_control_engine::control_keyboard_translation(){
  Set* set = sceneManager->get_set_scene();
  ImGuiIO io = ImGui::GetIO();
  //----------------------------
...
//Mouse
void GUI_control_engine::control_mouse(ImVec2 center){
  ImGuiIO io = ImGui::GetIO();
...
void GUI_control_engine::control_mouse_wheel(){
