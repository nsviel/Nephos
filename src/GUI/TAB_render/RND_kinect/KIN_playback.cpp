...
void KIN_playback::show_player(){
  ...
  ImU32 color = (*thread_paused) ? IM_COL32(46, 133, 45, 255) : IM_COL32(133, 133, 45, 255);
  string icon = (*thread_paused) ? (ICON_FA_PLAY "##36") : (ICON_FA_PAUSE "##36");
  ...
  if(*thread_restart) ImGui::PushStyleColor(ImGuiCol_Button, IM_COL32(133, 45, 45, 255));
