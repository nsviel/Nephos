...
void RND_tab::create_panels(){
  ...
  this->rnd_kinect = new gui::rnd::panel::RND_kinect(gui, &gui_render_panel->show_kinect, "Kinect");
  this->rnd_capture = new gui::rnd::panel::RND_capture(gui, &gui_render_panel->show_capture, "Capture");
