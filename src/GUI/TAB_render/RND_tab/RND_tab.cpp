...
void RND_tab::create_panels(){
  ...
  this->rnd_object = new gui::rnd::panel::RND_object(gui, &gui_render_panel->show_object, "data::Object");
  this->rnd_set = new gui::rnd::panel::RND_set(gui, &gui_render_panel->show_set, "Set");
  ...
  this->rnd_scene = new gui::rnd::panel::RND_scene(gui, &gui_render_panel->show_scene, "Scene");
  ...
  this->rnd_engine = new gui::rnd::panel::RND_engine(gui);
