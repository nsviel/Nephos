...
void Line::draw_subpass(vk::structure::Render& render){
...
//Subfunction
void Line::bind_pipeline(vk::structure::Render& render){
  //---------------------------
...
void Line::update_uniform(vk::structure::Render& render){
...
void Line::draw_data(vk::structure::Render& render){
  //---------------------------
