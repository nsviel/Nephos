...
//Main function
void Ressource::create_image(vk::structure::Image& image){
  //if(!vk_format->check_image_format(image)) return;
  //---------------------------
...
void Ressource::clean_image(vk::structure::Image& image){
  //---------------------------
...
void Ressource::clean_image_view(vk::structure::Image& image){
  //---------------------------
...
//Subfunction
void Ressource::create_image_handle(vk::structure::Image& image){
  //---------------------------
  ...
  image_info.usage = vk_format->find_usage_from_format(image);
...
void Ressource::create_image_view(vk::structure::Image& image){
  //---------------------------
...
void Ressource::create_image_sampler(vk::structure::Image& image){
  //---------------------------
