...
Dynamic::Dynamic(vk::Structure* vk_struct){
  //---------------------------
...
//Main function
void Dynamic::create_subpass(vk::structure::Renderpass& renderpass){
  //---------------------------
...
void Dynamic::draw_subpass(vk::structure::Subpass& subpass){
  //---------------------------
...
//Subfunction
void Dynamic::draw_pipeline_point(vk::structure::Subpass& subpass){
  //---------------------------
...
void Dynamic::draw_pipeline_line(vk::structure::Subpass& subpass){
  //---------------------------
...
void Dynamic::draw_pipeline_triangle(vk::structure::Subpass& subpass){
  //---------------------------
...
void Dynamic::draw_pipeline_dynamic(vk::structure::Subpass& subpass){
  //---------------------------
...
bool Dynamic::check_data(utl::base::Data& data, int typology){
  //---------------------------
