...
public:
  ...
  void update_descriptor_sampler(Struct_vk_binding* binding, vector<Struct_vk_image*> vec_image);
  void update_descriptor_sampler(Struct_vk_binding* binding, Struct_vk_image* image);
