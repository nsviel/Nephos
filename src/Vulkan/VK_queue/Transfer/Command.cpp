...
void Command::add_command(vk::structure::Command_buffer* command){
  mutex.lock();
  //---------------------------
...
//Submission
void Command::build_submission(std::vector<VkSubmitInfo>& vec_info){
  //---------------------------
...
void Command::make_submission(std::vector<VkSubmitInfo>& vec_info){
