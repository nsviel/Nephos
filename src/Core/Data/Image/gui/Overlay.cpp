...
//Main function
void Overlay::overlay_capture(std::shared_ptr<dat::base::Entity> entity, std::shared_ptr<utl::base::Image> image, ImVec2 size, ImVec2 image_pose){
  //---------------------------
/*
  //Hovered pixel
...
void Overlay::overlay_information(std::shared_ptr<dat::base::Entity> entity, std::shared_ptr<utl::base::Image> image){
  //---------------------------
/*
...
void Overlay::overlay_pixel(std::shared_ptr<utl::base::Image> image, ImVec2 size){
  //---------------------------
/*
...
void Overlay::compute_hovered_pixel(std::shared_ptr<utl::base::Image> image, ImVec2 size, ImVec2 image_pose, bool image_hovered){
  //---------------------------
/*
