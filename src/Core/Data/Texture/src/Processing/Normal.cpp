...
/*
//Main function
void Normal::compute_normal(std::shared_ptr<dat::base::Sensor> sensor, std::shared_ptr<utl::base::Image> depth, int width, int height, std::vector<glm::vec3>& vec_Nxyz){
  //---------------------------
...
//Method function
void Normal::compute_normal_with_gradient(std::shared_ptr<dat::base::Sensor> sensor, int width, int height, std::vector<glm::vec3>& vec_Nxyz){
  //---------------------------
...
void Normal::compute_normal_with_cov(std::shared_ptr<dat::base::Sensor> sensor, std::shared_ptr<utl::base::Image> depth, int width, int height, std::vector<glm::vec3>& vec_Nxyz){
  //---------------------------
...
void Normal::compute_normal_with_cov_img(std::shared_ptr<dat::base::Sensor> sensor, std::shared_ptr<utl::base::Image> depth, int width, int height, std::vector<glm::vec3>& vec_Nxyz){
  //---------------------------
...
//Subfunction
void Normal::compute_neigbor(std::shared_ptr<dat::base::Sensor> sensor, std::vector<glm::vec3>& vec_nn, int x, int y, int width, int height){
  //---------------------------
