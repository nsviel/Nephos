...
//Main function
void Operation::start_thread(std::shared_ptr<dat::base::Sensor> sensor){
  //---------------------------
...
void Operation::run_thread(std::shared_ptr<dat::base::Sensor> sensor){
  //---------------------------
...
//Subfunction
void Operation::make_normal_from_depth_image(std::shared_ptr<dat::base::Sensor> sensor){
...
void Operation::convert_normal_into_color(std::shared_ptr<dat::base::Sensor> sensor, std::vector<glm::vec3>& vec_Nxyz){
  //---------------------------
/*
