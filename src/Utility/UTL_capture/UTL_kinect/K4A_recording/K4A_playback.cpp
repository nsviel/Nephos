...
void K4A_playback::record_control(string path){
  ...
  // Device info
  recording.get_tag("K4A_DEVICE_SERIAL_NUMBER", &struct_record.info_device_serial_number);
  recording.get_tag("K4A_COLOR_FIRMWARE_VERSION", &struct_record.info_color_firmware_version);
  recording.get_tag("K4A_DEPTH_FIRMWARE_VERSION", &struct_record.info_depth_firmware_version);
