...
//Main function
void Rectangle::detect_rectangle(cv::Mat& image, std::shared_ptr<utl::base::Image> output){
...
//Subfunction
void Rectangle::compute_rectangle_detection(cv::Mat& image, std::shared_ptr<utl::base::Image> output){
  //---------------------------
