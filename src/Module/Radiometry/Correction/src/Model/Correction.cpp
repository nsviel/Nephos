...
//Main function
void Correction::make_image_correction(std::shared_ptr<dat::base::Sensor> sensor, utl::media::Image* ir){
...
//Subfunction
void Correction::make_correction(std::shared_ptr<dat::base::Sensor> sensor, utl::media::Image* ir, std::vector<uint8_t>& vec_data){
  //---------------------------
...
void Correction::update_correction_image(std::shared_ptr<dat::base::Sensor> sensor, utl::media::Image* ir, std::vector<uint8_t>& vec_data){
  //---------------------------
