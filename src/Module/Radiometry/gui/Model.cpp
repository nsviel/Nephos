...
//Main function
void Model::draw_calibration_player(dat::base::Sensor* sensor){
  //---------------------------
...
void Model::draw_calibration_tab(dat::base::Sensor* sensor){
  //---------------------------
...
void Model::draw_calibration_measure(dat::base::Sensor* sensor){
...
void Model::draw_calibration_model(dat::base::Sensor* sensor){
...
//Subfunction
void Model::draw_measure(dat::base::Sensor* sensor){
  //---------------------------
...
void Model::plot_measure_IfR(dat::base::Sensor* sensor, float height){
  rad::structure::Measure* measure = &radio_struct->model.measure;
  //---------------------------
...
void Model::plot_measure_IfIt(dat::base::Sensor* sensor, float height){
  rad::structure::Measure* measure = &radio_struct->model.measure;
  //---------------------------
