...
namespace rad::detection::cloud{class Process;}
...
public:
  ...
  inline rad::detection::cloud::Process* get_rad_process(){return rad_process;}
  inline rad::detection::cloud::Ransac* get_rad_ransac(){return rad_ransac;}
...
private:
  ...
  rad::detection::cloud::Process* rad_process;
  rad::Model* rad_model;
