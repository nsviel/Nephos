...
//Main function
util::base::File* Parser_HDL32::parse_packet(std::vector<int> packet){
  util::base::File* cloud = new util::base::File();
  //---------------------------
...
void Parser_HDL32::final_check(util::base::File* cloud){
  //---------------------------
