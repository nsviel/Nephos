...
//Main function
utility::base::File* Parser_HDL32::parse_packet(std::vector<int> packet){
  utility::base::File* cloud = new utility::base::File();
  //---------------------------
...
void Parser_HDL32::final_check(utility::base::File* cloud){
  //---------------------------
