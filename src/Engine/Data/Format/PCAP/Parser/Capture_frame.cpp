...
Capture_frame::Capture_frame(){
  ...
  this->frame_onrun = new utility::base::File();
  this->frame_ended = new utility::base::File();
...
//Main function
bool Capture_frame::build_frame(utility::base::File* data_udp){
...
//Subfunctions
void Capture_frame::add_cloudsToFrame(utility::base::File* data_udp){
  //---------------------------
...
void Capture_frame::end_cloudsToFrame(utility::base::File* data_udp, int index){
  //---------------------------
  ...
  *frame_ended = *frame_onrun;
  delete frame_onrun;
  frame_onrun = new utility::base::File();
