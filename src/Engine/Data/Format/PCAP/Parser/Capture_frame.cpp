...
Capture_frame::Capture_frame(){
  ...
  this->frame_onrun = new util::base::File();
  this->frame_ended = new util::base::File();
...
//Main function
bool Capture_frame::build_frame(util::base::File* data_udp){
...
//Subfunctions
void Capture_frame::add_cloudsToFrame(util::base::File* data_udp){
  //---------------------------
...
void Capture_frame::end_cloudsToFrame(util::base::File* data_udp, int index){
  //---------------------------
  ...
  *frame_ended = *frame_onrun;
  delete frame_onrun;
  frame_onrun = new util::base::File();
