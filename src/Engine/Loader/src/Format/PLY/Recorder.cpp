...
void Recorder::export_ascii(utl::base::Data* data, std::string path){
...
void Recorder::export_binary(utl::base::Data* data, utl::base::Pose* pose, std::string path){
...
//Subfunction
void Recorder::write_header(std::ofstream& file, std::string format, utl::base::Data* data){
  //---------------------------
...
void Recorder::write_data_ascii(std::ofstream& file, utl::base::Data* data){
  //---------------------------
...
void Recorder::write_data_binary(std::ofstream& file, utl::base::Data* data, utl::base::Pose* pose){
  //---------------------------
