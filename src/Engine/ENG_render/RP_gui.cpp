...
void RP_gui::create_subpass(Struct_vk_renderpass* renderpass){
  //---------------------------
  ...
  subpass->draw_task = [this](Struct_vk_subpass* subpass){RP_gui::draw(subpass);};
...
void RP_gui::draw(Struct_vk_subpass* subpass){
  //---------------------------
