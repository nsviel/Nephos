...
//Main function
void Device::show_profiler(prf::base::Profiler* profiler){
  //---------------------------
...
//Tab function
void Device::draw_tab_device(prf::hardware::Structure* prf_struct, ImVec2 dimension){
  //---------------------------
...
void Device::draw_tab_gpu(prf::hardware::Structure* prf_struct, ImVec2 dimension){
  //---------------------------
...
void Device::draw_gpu_info(prf::hardware::Structure* prf_struct){
  //---------------------------
...
void Device::draw_gpu_queue(prf::hardware::Structure* prf_struct){
  //---------------------------
