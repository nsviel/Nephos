...
private:
  //Header
  bool parse_header(io::importer::Configuration& ply_struct);
  void parse_header_format(io::importer::Configuration& ply_struct, std::string format);
  bool parse_header_size(io::importer::Configuration& ply_struct, std::string nb_vertex);
  void parse_header_property(io::importer::Configuration& ply_struct, std::string type, std::string field);
