...
vector<vec4> Heatmap::heatmap_height(entity::Object* object){
  //---------------------------

  vector<float> z_vec = attribManager->retrieve_z_vector(object->data);
...
vector<vec4> Heatmap::heatmap_height(entity::Object* object, vec2 range){
  //---------------------------
