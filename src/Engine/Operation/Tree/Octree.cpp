...
/*
//Main function
void Octree::create_octree(eng::data::Object* object){
  this->nb_level = 6;
  //---------------------------
...
toc_ms("octree");
  ...
  eng::data::Object* glyph = &cloud->glyphs["tree"];
  glyph->xyz = root->xyz;
  glyph->rgb = root->rgb;
...
void Octree::create_octree(eng::data::Object* object, int level){
  this->nb_level = level;
  //---------------------------
...
void Octree::build_root(eng::data::Object* object){
  //---------------------------
