...
void EDL_shader::init_shader(){
  ...
  shader_info->path_glsl_vs = "../src/Engine/Render/ENG_shader/EDL/glsl/shader_edl_vs.vert";
  shader_info->path_glsl_fs = "../src/Engine/Render/ENG_shader/EDL/glsl/shader_edl_fs.frag";
  shader_info->path_spir_vs = "../src/Engine/Render/ENG_shader/EDL/spir/shader_edl_vs.spv";
  shader_info->path_spir_fs = "../src/Engine/Render/ENG_shader/EDL/spir/shader_edl_fs.spv";
