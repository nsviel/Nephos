...
//Main function
eng::base::File* Parser_VLP16::parse_packet(std::vector<int> packet_dec){
  eng::base::File* data_udp = new eng::base::File();
  //---------------------------
...
void Parser_VLP16::reorder_by_azimuth(eng::base::File* cloud){
  //---------------------------
