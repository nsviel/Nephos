...
void Entity::init(){
  ...
  this->set_scene = data_set->get_subset("Entity");
...
//Entity function
void Entity::import_entity(utl::type::Entity* entity){
  //---------------------------
...
void Entity::assign_entity_UID(utl::type::Entity* entity){
  //---------------------------
...
//Set function
void Entity::delete_subset(utl::type::Set* set){
...
utl::type::Set* Entity::get_or_create_subset(string name){
  //---------------------------
