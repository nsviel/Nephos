...
//Main function
void Configuration::init_device_calibration(K4A_device* k4a_device){
  //---------------------------
...
void Configuration::init_playback_calibration(K4A_device* k4a_device){
  //---------------------------
...
void Configuration::init_device_transformation(K4A_device* k4a_device){
  //---------------------------
...
void Configuration::make_k4a_configuration(K4A_device* k4a_device){
  //---------------------------
...
void Configuration::find_file_information(K4A_device* k4a_device){
  //---------------------------
