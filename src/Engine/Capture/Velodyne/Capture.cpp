...
//Capturing functions
void Capture::start_watcher(int port){
...
//LiDAR function
void Capture::lidar_start_motor(){
  //---------------------------
...
void Capture::lidar_check_status(){
...
void Capture::lidar_check_connection(){
  //---------------------------
...
void Capture::lidar_set_rpm(int value){
  //---------------------------
...
void Capture::lidar_set_cameraFOV_min(int value){
  this->fov_min = value;
  //---------------------------
...
void Capture::lidar_set_cameraFOV_max(int value){
  this->fov_max = value;
  //---------------------------
...
void Capture::lidar_set_cameraFOV(int min, int max){
  this->fov_min = min;
  this->fov_max = max;
  //---------------------------
