...
//Main function
void K4A_playback::start_thread(k4n::truc::K4A_device* k4a_device){
  //---------------------------
...
void K4A_playback::run_thread(k4n::truc::K4A_device* k4a_device){
  //---------------------------
...
void K4A_playback::find_duration(k4n::truc::K4A_device* k4a_device){
...
void K4A_playback::manage_query_ts(k4n::truc::K4A_device* k4a_device){
  //---------------------------
...
void K4A_playback::manage_pause(k4n::truc::K4A_device* k4a_device){
  //---------------------------
...
void K4A_playback::manage_restart(k4n::truc::K4A_device* k4a_device){
  //---------------------------
...
void K4A_playback::manage_recording(k4n::truc::K4A_device* k4a_device, k4a::capture capture){
  //---------------------------
