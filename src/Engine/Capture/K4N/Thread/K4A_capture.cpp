...
//Subfunction
void K4A_capture::run_thread(k4n::Device* k4a_device){
...
void K4A_capture::manage_pause(k4n::Device* k4a_device){
  //---------------------------
...
void K4A_capture::manage_recording(k4n::Device* k4a_device, k4a::capture capture){
  //---------------------------
...
void K4A_capture::manage_color_setting(k4n::Device* k4a_device){
  //---------------------------
