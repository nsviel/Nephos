...
//Main function
void Configuration::init_device_calibration(k4n::truc::K4A_device* k4a_device){
  //---------------------------
...
void Configuration::init_playback_calibration(k4n::truc::K4A_device* k4a_device){
  //---------------------------
...
void Configuration::init_device_transformation(k4n::truc::K4A_device* k4a_device){
  //---------------------------
...
void Configuration::make_k4a_configuration(k4n::truc::K4A_device* k4a_device){
  //---------------------------
...
void Configuration::find_file_information(k4n::truc::K4A_device* k4a_device){
  //---------------------------
