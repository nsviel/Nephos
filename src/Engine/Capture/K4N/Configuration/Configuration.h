...
public:
  //Main function
  void init_playback_calibration(k4n::device::Device* k4a_device);
  void init_device_calibration(k4n::device::Device* k4a_device);
  void init_device_transformation(k4n::device::Device* k4a_device);
  void make_k4a_configuration(k4n::device::Device* k4a_device);
  void find_file_information(k4n::device::Device* k4a_device);
