...
//Main function
void Calibration::make_device_transformation(k4n::src::dev::Sensor* k4n_sensor){
  //---------------------------
...
void Calibration::make_capture_calibration(k4n::src::dev::Sensor* k4n_sensor){
  //---------------------------
...
void Calibration::find_playback_calibration(k4n::src::dev::Sensor* k4n_sensor){
  //---------------------------
