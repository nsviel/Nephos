...
//Main function
void Calibration::make_device_transformation(eng::k4n::dev::Sensor* k4n_sensor){
  //---------------------------
...
void Calibration::make_capture_calibration(eng::k4n::dev::Sensor* k4n_sensor){
  //---------------------------
...
void Calibration::find_playback_calibration(eng::k4n::dev::Sensor* k4n_sensor){
  //---------------------------
