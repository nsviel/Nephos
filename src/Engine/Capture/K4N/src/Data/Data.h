...
public:
  ...
  //Data function
  void find_depth(k4n::dev::Sensor* k4n_sensor, k4a::capture capture);
  void find_color(k4n::dev::Sensor* k4n_sensor, k4a::capture capture);
  void find_color_from_depth(k4n::dev::Sensor* k4n_sensor, k4a::capture capture, k4a::transformation& transformation);
  void find_ir(k4n::dev::Sensor* k4n_sensor, k4a::capture capture);
