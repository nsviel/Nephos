...
//Main function
void Cloud::convert_into_cloud(k4n::device::Device* k4a_device){
  //---------------------------
...
//Loop function
void Cloud::loop_init(k4n::device::Device* k4a_device){
...
void Cloud::loop_data(k4n::device::Device* k4a_device){
  if(k4a_device->depth.image.data.empty()) return;
  //---------------------------
...
void Cloud::loop_end(k4n::device::Device* k4a_device){
  if(k4a_device->depth.image.data.empty()) return;
  //---------------------------
...
void Cloud::retrieve_color(k4n::device::Device* k4a_device, int i){
  //---------------------------
...
void Cloud::retrieve_ir(k4n::device::Device* k4a_device, int i){
...
void Cloud::retrieve_corner_coordinate(k4n::device::Device* k4a_device){
  //---------------------------
