...
//Main function
utl::file::Data* HDL32::parse_packet(vector<int> packet){
  utl::file::Data* cloud = new utl::file::Data();
  //---------------------------
...
void HDL32::final_check(utl::file::Data* cloud){
  //---------------------------
