...
//Camera movement
void Arcball::camera_forward(eng::base::Camera* camera, float speed){
  //---------------------------
...
void Arcball::camera_backward(eng::base::Camera* camera, float speed){
  //---------------------------
...
void Arcball::camera_right(eng::base::Camera* camera, float speed){
  //---------------------------
...
void Arcball::camera_left(eng::base::Camera* camera, float speed){
  //---------------------------
...
void Arcball::camera_up(eng::base::Camera* camera, float speed){
  //---------------------------
...
void Arcball::camera_down(eng::base::Camera* camera, float speed){
  //---------------------------
...
void Arcball::camera_mouse(eng::base::Camera* camera){
  //---------------------------
...
void Arcball::camera_zoom(eng::base::Camera* camera, float speed){
  //---------------------------
...
//Camera matrix
mat4 Arcball::compute_camera_view(eng::base::Camera* camera){
  mat4 cam_view;
  //---------------------------
...
//Subfunction
void Arcball::rotate_by_angle(eng::base::Camera* camera, vec2 angle){
  //---------------------------
...
void Arcball::displace_camera_COM(eng::base::Camera* camera, const vec3& displacement){
  //---------------------------
