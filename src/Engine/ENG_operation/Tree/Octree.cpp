...
#include <Utility/UTL_specific/color.h>
...
/*
//Main function
void Octree::create_octree(eng::structure::Object* object){
  this->nb_level = 6;
  //---------------------------
...
toc_ms("octree");
  ...
  eng::structure::Glyph* glyph = &cloud->glyphs["tree"];
  glyph->xyz = root->xyz;
  glyph->rgb = root->rgb;
...
void Octree::create_octree(eng::structure::Object* object, int level){
  this->nb_level = level;
  //---------------------------
...
void Octree::build_root(eng::structure::Object* object){
  //---------------------------
