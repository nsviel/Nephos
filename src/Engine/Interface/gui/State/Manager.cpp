...
Manager::Manager(itf::Node* node_interface){
  //---------------------------

  this->node_interface = node_interface;
  this->sta_struct = new itf::state::Structure();
  this->gui_save = new itf::state::Saver(this);
  this->gui_load = new itf::state::Loader(this);
  this->gui_logic = new itf::state::Logic(this);
